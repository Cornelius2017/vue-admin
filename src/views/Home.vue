<template>
    <div class="home">
        <v-toolbar class="mt-5" flat>
                ...
                <v-tabs v-model="tab" color="purple" slider-size="3">
                    ...
                    <v-tab>
                        <v-btn fab color="red lighten-4" elevation="0">
                            <v-icon color="red">fa-solid fa-indian-rupee-sign</v-icon>
                        </v-btn>
                    </v-tab>
                    <v-tab>
                        <v-btn fab color="blue lighten-4" elevation="0">
                            <v-icon color="blue">fas fa-yen-sign</v-icon>
                        </v-btn>
                    </v-tab>
                    <v-tab>
            ...
            <v-badge boredered bottom color="green" dot offset-x="10" offset-y="10">
                <v-avatar size="40">
                    ...
                    <v-col cols="12" md="6">
                        <v-card>
                            <v-app-bar flat color="rgba(0,0,0,0)">
                                ...
                                <v-spacer></v-spacer>
                                <v-btn color="deep-purple" class="white--text mt-2 mr-2">Weekly</v-btn>
                                <v-btn color="deep-purple lighten-4" class="deep-purple--text mt-2">Montly</v-btn>
                            </v-app-bar>
                        ...
                        <v-card>
                            ...
                            <v-app-bar flat color="rgba(0,0,0,0)">
                                ...
                                <v-toolbar-title class="title black--text ml-2">
                                    Sent Bitcoin <br><span class="caption">
                                    To Bitcoin Address
                                    </span>
                                </v-toolbar-title>
                                <v-spacer></v-spacer>
                                ...
                                <v-icon color="green" class="ml-2">fa-solid fa-up-long</v-icon>
                            </v-app-bar>
                            <v-app-bar flat color="rgba(0,0,0,0)">
                                <v-btn fab color="green lighten-4" elevation="0">
                                    <v-icon color="green"> fa-solid fa-yen-sign </v-icon>
                                </v-btn>
                                <v-toolbar-title class="title black--text ml-2">
                                    Receive Lightcoin <br><span class="caption">
                                    Pending
                                    </span>
                                </v-toolbar-title>
                                <v-spacer></v-spacer>
                                ...
                                <v-icon color="red" class="ml-2">fa-solid fa-down-long</v-icon>
                            </v-app-bar>
                        </v-card>
                    </v-col>
                    <v-col cols="12" md="6">
                        <v-card height="180px">
                            <v-row>
                                ...
                                <v-col cols="12" sm="8">
                                    <v-sparkline :value="value" :smooth="radius || false" :padding="padding" :line-width="width" :stroke-linecap="lineCap" :fill="fills" :type="type" :auto-line-width="autoLineWidth" auto-draw color="red">
                                    </v-sparkline>
                                    <v-card-action class="justify-end">
                                        <v-btn text color="green">
                                            <v-icon class="mt-n2 pr-2">
                                                fas fa-sort-down
                                            </v-icon>8.5
                                        </v-btn>
                                    </v-card-action>
                                                ...
                                                <v-list-item three-line>
                                                    <v-list-item-content>
                                                        ...
                                                        <v-row>
                                                            <v-col cols="12" sm="6">
                                                                <v-progress-circular
                                                                rotate="360" size="100" width="15" value="70" color="teal"
                                                                >
                                                                    70%
                                                                </v-progress-circular>
                                                            </v-col>
